...
const PUBLIC_PROJECTS: Project[] = [
  {
    ...
    shortDesc: 'Sistema privado de IA aplicada com stack verificada por componente.',
    number: '01 / 06',
    year: '2026',
    status: 'PROJETO PRIVADO EM DESENVOLVIMENTO',
    statusDetail: 'Código, credenciais e dados operacionais permanecem privados.',
    problem: 'Pesquisa, validação, scoring e organização de leads B2B ficam fragmentados quando cada etapa usa uma ferramenta diferente.',
    solution: 'Núcleo em TypeScript/Node.js, servidor Express e dashboard React, com componentes de coleta, validação, scoring, deduplicação, organização e mensageria. Python aparece somente em utilitários auxiliares ou históricos.',
    stack: ['TYPESCRIPT', 'NODE.JS', 'EXPRESS', 'REACT', 'APIS', 'BAILEYS'],
    demonstrates: 'IA aplicada, automação, integrações e organização de dados',
    image: '/projetos/lead inteligence.png',
  ...
  {
    category: 'PROVEDORES DE IA',
    title: 'Adaptadores de Provedores de IA',
    shortDesc: 'Serviços privados que expõem Kimi, DeepSeek, Gemini e GLM em formato OpenAI.',
    number: '02 / 06',
    year: '2026',
    status: 'CÓDIGO PRIVADO / EXPERIMENTAL',
    statusDetail: 'Sem repositório público; Qwen é referência de terceiros creditada.',
    problem: 'Diferentes provedores e modelos possuem protocolos e formatos distintos, dificultando seu consumo uniforme por agentes e ferramentas.',
    solution: 'Implementações separadas para Kimi, DeepSeek, Gemini e GLM/Z.AI com streaming SSE, sessões, emulação de tool-calling e telemetria. Qwen é operado a partir do projeto de terceiros creditado e não é autoria própria.',
    stack: ['NODE.JS', 'TYPESCRIPT', 'HONO', 'PLAYWRIGHT', 'SSE', 'OPENAI-COMPATÍVEL'],
    demonstrates: 'Integrações, protocolos e streaming',
    image: '/assets/case-max-ai.jpg',
  },
  {
    category: 'SISTEMA DE AGENTES E REVISÃO',
    title: 'Opportunity OS',
    shortDesc: 'Projeto em desenvolvimento para organizar e revisar diferentes oportunidades digitais.',
    number: '03 / 06',
    year: '2026',
    status: 'EM DESENVOLVIMENTO',
    statusDetail: 'Validação atual incompleta; nenhuma ação externa ou resultado financeiro é prometido.',
    problem: 'Fatos, estimativas e decisões sobre oportunidades ficam dispersos e difíceis de auditar.',
    solution: 'Implementado: organização de fatos, relatórios locais, persistência SQLite, filas de aprovação e rascunhos em modo SHADOW. Falta estabilizar toda a suíte, validar operação contínua e confirmar provedores.',
    stack: ['NODE.JS', 'SQLITE', 'PLAYWRIGHT', 'AGENTES', 'MODO SHADOW'],
    demonstrates: 'Rastreabilidade, aprovação humana e desenho fail-closed',
    image: '/assets/lab-automation-hub.jpg',
  },
  {
    category: 'GESTÃO DE OPORTUNIDADES',
    title: 'Hunter Jobs',
    shortDesc: 'Ferramenta própria em Node.js/TypeScript para organizar busca e revisão de vagas.',
    number: '04 / 06',
    year: '2026',
    status: 'FERRAMENTA INTERNA FUNCIONAL',
    statusDetail: 'Repositório público é uma edição sanitizada com dados sintéticos.',
    problem: 'Buscar vagas em várias fontes gera duplicatas, formatos incompatíveis e decisões repetitivas.',
    solution: 'Pipeline Node.js/TypeScript com coletores, normalização, scoring, deduplicação, persistência, dashboard e revisão humana. A edição pública não representa todos os componentes privados.',
    stack: ['NODE.JS', 'TYPESCRIPT', 'SCORING', 'PERSISTÊNCIA', 'DASHBOARD'],
    demonstrates: 'Pipeline tipado, regras explicáveis e revisão humana',
  ...
  },
  {
    ...
    title: 'PowerFit',
    shortDesc: 'Piloto entregue com trabalho de banco e demo pública frontend separada.',
    number: '05 / 06',
    year: '2026',
    status: 'PILOTO FUNCIONAL REMUNERADO',
    statusDetail: 'A demo pública não representa banco integralmente conectado.',
    problem: 'Personal trainers gerenciam alunos, treinos e rotinas em ferramentas fragmentadas.',
    solution: 'Piloto entregue: aplicação e trabalho de modelagem/integração com Supabase e PostgreSQL. Demo pública: React, JavaScript/JSX e Vite com localStorage; banco não está integralmente conectado nessa versão.',
    stack: ['REACT', 'JAVASCRIPT/JSX', 'VITE', 'LOCALSTORAGE', 'SUPABASE/POSTGRESQL (PILOTO)'],
    demonstrates: 'Separação de versões, interface e modelagem de dados',
    image: '/projetos/powerfit.jpeg',
  ...
  },
  {
    ...
    title: 'BetsCount',
    shortDesc: 'Ferramenta privada de IA e mensageria com contexto e persistência por usuário.',
    number: '06 / 06',
    year: '2026',
    status: 'FERRAMENTA PRIVADA',
    statusDetail: 'Implementação local verificada; hospedagem e teste citados são históricos.',
    problem: 'Operadores precisam consultar informações em tempo real sem compartilhar contexto entre usuários.',
    solution: 'Implementação local em Node.js/Express, Supabase/PostgreSQL, API de IA e mensageria. Há registro histórico de hospedagem na Northflank e teste com cinco operadores simultâneos, sem representar escala ou disponibilidade atual.',
    stack: ['NODE.JS', 'EXPRESS', 'SUPABASE', 'POSTGRESQL', 'API DE IA'],
