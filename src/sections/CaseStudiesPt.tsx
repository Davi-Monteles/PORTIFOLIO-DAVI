...
const PUBLIC_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    shortDesc: 'Servidor e bot Node.js construídos e entregues para cliente.',
    number: '06 / 06',
    year: '2026',
    status: 'PROJETO PRIVADO PARA CLIENTE',
    statusDetail: 'Código e detalhes da comunidade permanecem privados.',
    problem: 'Comunidades precisam de canais, cargos, permissões e automações consistentes.',
    solution: 'Servidor e bot Discord construídos sob medida em Node.js/discord.js, com estrutura de canais, cargos, permissões e automações.',
    stack: ['NODE.JS', 'DISCORD.JS', 'APIS', 'AUTOMAÇÃO'],
    demonstrates: 'Entrega para cliente, permissões e integrações',
