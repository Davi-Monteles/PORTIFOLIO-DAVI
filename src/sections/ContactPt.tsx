  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="block" style={{ color: '#F3F1EA' }}>PRECISA DE UM SISTEMA,</span>
          <span className="block">
            <span style={{ color: '#F3F1EA' }}>NÃO SÓ DE UMA </span>
            <span className="text-gradient-useful" style={{ textShadow: '0 0 40px rgba(126,255,107,0.3)' }}>PÁGINA?</span>
          </span>
        </h2>
        ...
        >
          Vamos construir um site, fluxo de IA ou ferramenta interna que realmente ajude sua operação.
        </p>
