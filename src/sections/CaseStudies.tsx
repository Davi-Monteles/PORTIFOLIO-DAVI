...
const PROJECTS: Project[] = [
  {
    ...
    solution: 'A system that automatically researches, scores and organizes leads by business fit. Outcome: faster prospecting, better outreach quality and a structured pipeline that scales.',
    stack: ['PYTHON', 'N8N', 'GOOGLE SHEETS', 'APIs'],
